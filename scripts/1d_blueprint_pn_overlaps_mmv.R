...
mmv_reservoirs <- c("Calomys musculinus", 
                    "Mastomys natalensis", 
                    "Mus musculus", 
                    "Rattus norvegicus", 
...
positive_species <- c(pseudo_reservoir_pool, mmv_reservoirs)
...
# tab_overlaps <- NULL
tab_overlaps <- read.csv(".../data/tab_overlaps_mmv.csv")
...
endem_map <- ecoregions_transformed_reproj[ecoregions_transformed_reproj$Regions %in% c("African", "Guineo-Congolian", "Mexican", "North American", "Panamanian", "Amazonian", "South American", "Eurasian"), ]
